...
class SEBasicBlock(nn.Module):
    """SENet with instance normalization."""
...
class Generator(nn.Module):
    ...
    def __init__(self, conv_dim=64, c_dim=5, repeat_num=6):
        ...
        for i in range(repeat_num):
            ...
            #layers.append(SEBasicBlock(dim_in=curr_dim, dim_out=curr_dim))
    ...
    def forward(self, x, c):
        ...
        print("type(self.main(x)) : {}".format(type(self.main(x))))
        return self.main(x)
